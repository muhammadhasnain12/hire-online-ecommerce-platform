...
export async function signinUser(user) {
    ...
    await axios
        ...
        .then(function (res) {
            // console.log(res);
            if (res.data.success) {
                setInStorage('react_login_app', { token: res.data.token, userId: res.data.userId });
                data_success = res.data.success;
...
// Post Add Details
export async function postAdd(addDetails) {
    var data_success, data_error;
    await axios
        .post('api/Users/postAdd', addDetails)
        .then(function (res) {
            console.log(res);
            data_success = res.data.success;
            data_error = res.data.message;
    ...
    console.log("UserAction clearification = ", data)
    return data;
}

// Post Add Details
export async function postReviews(addDetails) {
    var data_success, data_error;
    await axios
        .post('api/Users/postreviews', addDetails)
        .then(function (res) {
            console.log(res);
            // data_success = res.data.success;
            // data_error = res.data.message;
...
// Add Favourite listing in DB
export async function addFavourite(favListing) {
    var data_success, data_error;
    await axios
        .post('api/Users/addfavourite', favListing)
        .then(function (res) {
            console.log(res);
            data_success = res.data.success;
            data_error = res.data.message;
...
// Book product
export async function bookingProduct(bookingData) {
    var data_success, data_error;
    await axios
        .post('api/Users/bookingproduct', bookingData)
        .then(function (res) {
            console.log(res);
            data_success = res.data.success;
            data_error = res.data.message;
...
// Post Add Details
// export async function searchPost(addDetail) {
//     var data_success, data_error;
//     await axios
//         .post('api/Users/searchPost', addDetail)
//         .then(function (res) {
//             console.log(res);
//             data_success = res.data.success;
//             data_error = res.data.message;
